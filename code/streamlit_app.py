...
st.text(f"Current Wind Speed: {wind_speed} meters/second")
st.text(f"Current Wind Direction: {wind_direction} degrees from true North")

st.subheader("Buoy: https://www.ndbc.noaa.gov/station_page.php?station=51201")
st.text(f"Current Wave Direction: {dominant_wave_direction} degrees from true North")
st.text(f"Avg. Wave Period 1 hour ago: {avg_period_1_h} seconds")
st.text(f"Dominant Wave Period 1.5 hours ago: {dominant_period_1_5_h} seconds")
st.text(f"Wave Height 3 hours ago: {wave_height_3_h} meters")
st.text(f"Wave Direction 6 hours ago: {dominant_wave_direction_6_h} degrees from true North")
st.text(f"Dominant Wave Period 6 hours ago: {dominant_period_6_h} seconds")
st.text(f"Average Wave Period 6 hours ago: {avg_period_6_h} seconds")
st.text(f"Average Wave Period 9 hours ago: {avg_period_9_h} seconds")
